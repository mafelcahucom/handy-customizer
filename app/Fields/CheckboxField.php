...
use Handy\Controls\CheckboxControl;
...
final class CheckboxField extends Setting {
    ...
    /**
     * Return the validated default value. Validate default if a boolean.
     * 
     * @since 1.0.0
     *
    ...
    private function get_validated_default( $default ) {
        return ( is_bool( $default ) ? true : false );
    }
     ...
     * @param  array   $args       Contains the arguments needed to render checkbox control.
     * $args = [
