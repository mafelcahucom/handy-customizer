<?php
/**
 * App > Modules > Textarea > Field > Textarea Field.
 *
 * @since   1.0.0
 *
 * @version 1.0.0
...
namespace Handy\Modules\Textarea\Field;

use Handy\Core\Setting;
use Handy\Inc\Validator;
use Handy\Modules\Textarea\Control\TextareaControl;

defined( 'ABSPATH' ) || exit;

/**
 * The `TextareaField` class contains the settings,
...
final class TextareaField extends Setting {
     ...
     * @param  array  $args      Contains the necessary arguments to render textarea control.
     * $args = [
