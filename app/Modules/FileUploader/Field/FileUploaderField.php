<?php
/**
 * App > Modules > File Uploader > Field > File Uploader Field.
 *
 * @since   1.0.0
 *
 * @version 1.0.0
...
/**
 * The `FileUploaderField` class contains the settings,
...
'psd',
     ...
     * @param  array  $args      Contains the necessary arguments to render file uploader control.
     * $args = [
