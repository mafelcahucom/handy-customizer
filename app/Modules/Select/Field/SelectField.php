<?php
/**
 * App > Modules > Select > Field > Select Field.
 *
 * @since   1.0.0
 *
 * @version 1.0.0
...
namespace Handy\Modules\Select\Field;

use Handy\Core\Setting;
use Handy\Inc\Validator;
use Handy\Modules\Select\Control\SelectControl;

defined( 'ABSPATH' ) || exit;

/**
 * The `SelectField` class contains the settings,
...
final class SelectField extends Setting {
     ...
     * @param  array  $args      Contains the necessary arguments to render select control.
     * $args = [
