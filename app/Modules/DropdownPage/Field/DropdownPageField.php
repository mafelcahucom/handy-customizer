<?php
/**
 * App > Modules > Dropdown Page > Field > Dropdown Page Field.
 *
 * @since   1.0.0
 *
 * @version 1.0.0
...
namespace Handy\Modules\DropdownPage\Field;

use Handy\Core\Setting;
use Handy\Inc\Helper;
use Handy\Inc\Validator;
use Handy\Modules\DropdownPage\Control\DropdownPageControl;

defined( 'ABSPATH' ) || exit;

/**
 * The `DropdownPageField` class contains the settings,
...
final class DropdownPageField extends Setting {
     ...
     * $args = [
     *     'status'      => (array)  Contains the status of the pages.
     *     'order'       => (string) Contains the order of pages.
     *     'placeholder' => (string) Contains the placeholder of the control.
     * ]
     * @return array
     */
    private function get_pages( $args = array() ) {
        $value  = array();
     ...
     * @param  array  $args      Contains the necessary arguments to render dropdown page control.
     * $args = [
     ...
     *     'status'            => (array)   Contains the list of page status
     *     'order'             => (string)  Contains the order of the pages.
     * ]
     * @return void
     */
    public function render( $customize, $args = array() ) {
        ...
        if ( ! empty( $validated ) ) {
            $validated['choices'] = $this->get_pages(array(
