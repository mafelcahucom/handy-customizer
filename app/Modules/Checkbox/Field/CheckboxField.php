<?php
/**
 * App > Modules > Checkbox > Field > Checkbox Field.
 *
 * @since   1.0.0
 *
 * @version 1.0.0
...
namespace Handy\Modules\Checkbox\Field;

use Handy\Core\Setting;
use Handy\Inc\Validator;
use Handy\Modules\Checkbox\Control\CheckboxControl;

defined( 'ABSPATH' ) || exit;

/**
 * The `CheckboxField` class contains the settings,
 * sanitization and validation.
 *
 * @since 1.0.0
 */
final class CheckboxField extends Setting {
     ...
     * @param  array  $args      Contains the necessary arguments to render checkbox control.
     * $args = [
     ...
     *     'priority'          => (integer) Contains the order of control appear in the section.
    ...
    public function render( $customize, $args = array() ) {
        ...
        if ( $validated && $config ) {
            $this->setting( 'checkbox', $customize, $validated );
            $customize->add_control( new CheckboxControl( $customize, $config['settings'], $config ) );
        }
    }
}
