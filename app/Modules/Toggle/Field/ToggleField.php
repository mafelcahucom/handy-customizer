<?php
/**
 * App > Modules > Toogle > Field > Toogle Field.
 *
 * @since   1.0.0
 *
 * @version 1.0.0
...
namespace Handy\Modules\Toggle\Field;

use Handy\Core\Setting;
use Handy\Inc\Validator;
use Handy\Modules\Toggle\Control\ToggleControl;

defined( 'ABSPATH' ) || exit;

/**
 * The `ToggleField` class contains the settings,
 * sanitization and validation.
 *
 * @since 1.0.0
 */
final class ToggleField extends Setting {
     ...
     * @param  array  $args      Contains the necessary arguments to render toggle control.
     * $args = [
    ...
    public function render( $customize, $args = array() ) {
        ...
        if ( $validated && $config ) {
            $this->setting( 'toggle', $customize, $validated );
            $customize->add_control( new ToggleControl( $customize, $config['settings'], $config ) );
        }
    }
}
