<?php
/**
 * App > Modules > Radio > Field > Radio Field.
 *
 * @since   1.0.0
 *
 * @version 1.0.0
...
namespace Handy\Modules\Radio\Field;

use Handy\Core\Setting;
use Handy\Inc\Validator;
use Handy\Modules\Radio\Control\RadioControl;

defined( 'ABSPATH' ) || exit;

/**
 * The `RadioField` class contains the settings,
 * sanitization and validation.
 *
 * @since 1.0.0
 */
final class RadioField extends Setting {
     ...
     * @param  array  $args      Contains the necessary arguments to render radio control.
     * $args = [
    ...
    public function render( $customize, $args = array() ) {
        ...
        if ( $validated && $config ) {
            $this->setting( 'radio', $customize, $validated );
            $customize->add_control( new RadioControl( $customize, $config['settings'], $config ) );
        }
    }
}
